...
public class GpuRequest extends ProductRequest{
	...
	public GpuRequest(String brand, String model, Integer stock, Double price, Integer vram,
	...
	public GpuRequest(Long id, String brand, String model, Integer stock, Double price,
